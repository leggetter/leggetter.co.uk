...
RealtimeCoService.prototype._init=function(a){var b=this;this._client=a.createClient();this._client.setId("LatencyClient");this._client.setConnectionTimeout(15E3);this._client.setClusterUrl("https://ortc-developers.realtime.co/server/2.1/");this._client.onConnected=function(){b._client.subscribe(b._channelName,!0,function(a,d,e){e=JSON.parse(e);b._onMessage(e)});b._onReady()};this._client.onException=function(a,d){var e=d;"Invalid connection."==d&&(e+=" Please reload the page to authenticate again");
...
HydnaService.prototype.disconnect=function(){this.channel.close()};function FanoutService(a,b){BenchmarkService.call(this,"!"+a,b);this.name="Fanout";this.realmId="d7d63e3a";this.client=new Faye.Client("https://"+this.realmId+".fanoutcdn.com/bayeux");var c=this;this.subscription=this.client.subscribe("/"+this._channelName,function(a){c._onMessage(a)});this.subscription.then(function(){c._onReady()})}FanoutService.prototype=new BenchmarkService;
FanoutService.prototype.send=function(a){var a={items:[{channel:this._channelName,formats:{"json-object":a}}]},b=new XMLHttpRequest;b.onreadystatechange=function(){};b.open("POST","https://api.fanout.io/realm/"+this.realmId+"/publish/",!0);b.setRequestHeader("Content-Type","application/json");b.send(JSON.stringify(a))};FanoutService.prototype.disconnect=function(){this.subscription.cancel()};
function DataMcFlyService(){BenchmarkService.apply(this,arguments);this.name="DataMcFly";this.benchmark=new DataMcFly("d45797ef-7392-442f-8de8-5303d306576c","benchmarks",this._channelName);this.benchmark.on("online",this._onOnline.bind(this));this.benchmark.on("added",this._childAdded.bind(this))}DataMcFlyService.prototype=new BenchmarkService;DataMcFlyService.prototype._onOnline=function(){this._onReady()};
DataMcFlyService.prototype._childAdded=function(a){a=a.value();this._log("DMF: childAdded: "+JSON.stringify(a));this._onMessage(a)};DataMcFlyService.prototype.send=function(a){this._log("DMF: sending: "+JSON.stringify(a));this.benchmark.push(a,function(){})};DataMcFlyService.prototype.disconnect=function(){this.benchmark.socket.close()};
function BenchmarkRunner(a,b){this.version="<VERSION>";this._services=a;this._options=b||{};this._serviceIndex;this._messageCountTo;this._messageCount;this._sendNextUponReceipt;this._serviceLatencyResults;this._logMessages;this._testChannelName;this._service;this._localMsg;this._messageCount;this._testLatencyResults;this.reset()}
BenchmarkRunner.prototype.reset=function(){this._serviceIndex=0;this._messageCountTo=20;this._sendNextUponReceipt=!0;this._serviceLatencyResults={};this._logMessages=[];this._testChannelName="private-"+"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"==a?b:b&3|8).toString(16)});this._testInit()};
