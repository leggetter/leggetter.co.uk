...
[Convex](https://www.convex.dev/llm-leaderboard) started first, in January 2025, and had the category more or less to itself for a year. [Clerk](https://clerk.com/llm-leaderboard) followed that October, then [Supabase](https://supabase.com/evals) in April 2026, [Auth0](https://auth0.com/agent-experience) in June, [Paddle](https://developer.paddle.com/llm-benchmark/) in July, and ours and [Rails](https://rubyonrails.org/ai) in August, dating each by when its repository first appeared. Almost none of this is more than a year old, and that's most of the reason nothing about it has settled.
